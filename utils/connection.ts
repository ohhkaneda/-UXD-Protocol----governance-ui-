...
const ENDPOINTS: EndpointInfo[] = [
  {
    name: 'mainnet',
    url:
      'https://billowing-proud-glitter.solana-mainnet.quiknode.pro/d8d865f9b286d5db05efc5d020dfdcbe0ed4c06f/', // process.env.MAINNET_RPC || 'https://ssc-dao.genesysgo.net',
  },
  {
    name: 'devnet',
    url:
