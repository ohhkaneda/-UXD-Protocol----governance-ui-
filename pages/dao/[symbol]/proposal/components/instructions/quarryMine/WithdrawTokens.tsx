...
import { withdrawTokensInstruction } from '@tools/sdk/quarryMine/withdrawTokens'
...
const WithdrawTokens = ({
  ...
  const [form, setForm] = useState<QuarryMineWithdrawTokensForm>({})
  ...
  async function getInstruction(): Promise<UiInstruction> {
    ...
    const tx = await withdrawTokensInstruction({
