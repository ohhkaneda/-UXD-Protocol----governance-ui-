...
import {
  UiInstruction,
  SaberPeripheryRedeemAllTokensFromMintProxyForm,
...
const RedeemAllTokensFromMintProxy = ({
  ...
  const [
    form,
    setForm,
  ] = useState<SaberPeripheryRedeemAllTokensFromMintProxyForm>({})
  ...
  async function getInstruction(): Promise<UiInstruction> {
    ...
    const tx = await redeemAllTokensFromMintProxyInstruction({
