...
import { gaugeRevertVoteInstruction } from '@tools/sdk/tribeca/gaugeRevertVoteInstruction'
...
const GaugeRevertVote = ({
  ...
  const [form, setForm] = useState<TribecaGaugeRevertVoteForm>({})
  ...
  async function getInstruction(): Promise<UiInstruction> {
    ...
    const tx = await gaugeRevertVoteInstruction({
      programs,
