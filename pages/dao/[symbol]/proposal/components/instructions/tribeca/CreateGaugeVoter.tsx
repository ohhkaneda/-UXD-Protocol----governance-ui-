...
import { createGaugeVoterInstruction } from '@tools/sdk/tribeca/createGaugeVoterInstruction'
...
const CreateGaugeVoter = ({
  ...
  const [form, setForm] = useState<TribecaCreateGaugeVoterForm>({})
