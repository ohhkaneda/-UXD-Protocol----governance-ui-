...
import { createEpochGaugeInstruction } from '@tools/sdk/tribeca/createEpochGaugeInstruction'
...
const CreateEpochGauge = ({
  ...
  const [form, setForm] = useState<TribecaCreateEpochGaugeForm>({})
