...
import {
  UiInstruction,
  TribecaResetEpochGaugeVoterForm,
...
import { resetEpochGaugeVoterInstruction } from '@tools/sdk/tribeca/resetEpochGaugeVoter'
...
const ResetEpochGaugeVoter = ({
  ...
  const [form, setForm] = useState<TribecaResetEpochGaugeVoterForm>({})
  ...
  async function getInstruction(): Promise<UiInstruction> {
    ...
    const tx = await resetEpochGaugeVoterInstruction({
      programs,
      authority: pubkey,
      tribecaConfiguration,
    })
