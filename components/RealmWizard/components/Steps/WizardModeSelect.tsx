    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-2 text-center ">
        <div className="flex justify-center pointer ">
          <div
            className="border px-5 py-3 w-6/12 hover:border-white"
            onClick={() => {
        ...
        <div className="flex justify-center ">
          <div
            className="border px-5 py-3 w-6/12 hover:border-white pointer"
            onClick={() => {
      ...
      <div className="flex justify-center">
        ...
        >
          <div className="border px-3 py-1.5 hover:border-primary-light hover:border-white hover:text-primary-dark transition-all duration-200 pointer mt-10 ">
